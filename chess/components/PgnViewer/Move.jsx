...
const Move = ({ move, suffix, glyph, fen, depth, previous, isActive, onClick, annotationColor }) => {
  return (
    <span
      id="pgn-move"
    ...
    >
      ...
      {glyph && <span className={classnames('ml-1 font-bold', annotationColor || 'text-green-500')}>{nagToSymbol(glyph)}</span>}
    </span>
  );
};
