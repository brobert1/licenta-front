  ...
  return (
    <main className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center flex-grow text-center mt-6">
        <h1 className="mb-4 text-2xl sm:text-5xl font-extrabold text-primary">404</h1>
        <h2 className="mb-6 text-xl sm:text-2xl font-semibold text-primary">Page not found 😢</h2>
