...
const Profile = () => {
  ...
  return (
    <div ref={ref} className="relative flex items-center gap-4">
      <div
        className="hidden py-2 px-4 rounded-lg cursor-pointer items-center space-x-2 md:flex"
        onClick={toggle}
        role="button"
      >
      ...
      {isOpen && (
        <div className="absolute top-14 right-2 z-50 w-56 rounded-lg bg-secondary shadow-xl">
          <ProfileMenu />
        </div>
      )}
    </div>
