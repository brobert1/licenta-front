...
const CourseDynamicPreviewCard = () => {
  ...
  return (
    <div className="flex lg:flex-row flex-col bg-secondary hover:bg-tertiary cursor-pointer p-3.5 lg:p-5 rounded-xl gap-4 shadow-xl ring-1 ring-white/10 hover:ring-white/20 transition-colors">
