...
const PositionSetup = () => {
  ...
  const handleCastlingChange = (key) => (e) => {
    setCastling((prev) => ({
      ...prev,
  ...
  return (
    <div className="position-setup flex flex-col text-white gap-4">
      <div className="flex gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="mb-2">
            <p className="text-white mb-1">Castling</p>
      ...
      <div className="flex gap-4 mt-2">
        <Button
          className="px-4 py-2 bg-zinc-700 hover:bg-gray-600 rounded flex-1"
          onClick={clearBoard}
        >
          Clear board
        </Button>
