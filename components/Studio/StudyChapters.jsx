    ...
    >
      <div
        className={classnames(
          'bg-surface border border-border rounded-t-md w-full h-full flex flex-col'
        )}
      >
        <div className="bg-secondary text-primary rounded-t-md">
          <div className="flex justify-between items-center text-primary font-semibold border-b p-2.5 border-border">
            <div className="flex gap-2 items-center">
              <span>🚀</span>
              <p>Chapters</p>
            </div>
            <Button
              className="text-muted hover:text-primary transition-colors duration-200 p-1 rounded hover:bg-tertiary"
        ...
        <div className="flex flex-col gap-1 p-2 text-muted overflow-y-auto flex-1 min-h-0">
          <SortableContext
