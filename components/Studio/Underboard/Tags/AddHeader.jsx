...
const AddHeader = ({ moments, tree, setTree }) => {
  ...
  return (
    <div className="mt-2">
      <select
        className="w-48 bg-tertiary text-primary border border-border rounded px-2 py-1 text-sm focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20"
        onChange={(e) => {
