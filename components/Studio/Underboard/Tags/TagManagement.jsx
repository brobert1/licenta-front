...
import TagsListSuccess from './TagsListSuccess';
    ...
    <div className="space-y-4">
      <div className="flex w-full max-w-xl flex-col gap-4 lg:flex-row">
        ...
        <Button
          ...
          className="rounded-md border border-border bg-secondary px-4 py-2 text-primary transition-colors hover:bg-tertiary w-full lg:w-auto"
