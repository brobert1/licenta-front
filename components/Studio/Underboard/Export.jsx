        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Button
              ...
              className="flex-1 px-3 py-2 text-sm bg-tertiary text-primary hover:bg-tertiary/80 transition-colors duration-200 rounded flex items-center justify-center"
              disabled={isCopied}
            >
              <i
