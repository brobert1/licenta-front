    ...
    <div className="p-3">
      <div className="space-y-3">
        <Textarea
          ...
          className="w-full h-24 bg-tertiary text-white border border-white/10 rounded p-2 resize-none focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent/20 whitespace-pre-wrap"
