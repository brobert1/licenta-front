...
const CoursePricing = () => {
  ...
  return (
    <div className={classnames('bg-surface border border-border w-full p-4 lg:rounded-lg lg:p-6 h-full')}>
      <h2 className="border-b border-border pb-2 text-primary text-lg font-semibold">Pricing</h2>
