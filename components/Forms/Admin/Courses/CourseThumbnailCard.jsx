...
const CourseThumbnailCard = () => {
  return (
    <div className="bg-surface border border-border w-full p-4 lg:rounded-lg lg:p-6 h-full flex flex-col">
      <h2 className="border-b border-border pb-2 text-primary text-lg font-semibold">Course Thumbnail</h2>
      <div className="mt-4 w-68 mx-auto">
        <ThumbnailUpload label="" />
      </div>
      <div className="mt-6 flex-1 flex flex-col pb-0">
        <h3 className="text-primary text-base font-semibold mb-3">Course Preview</h3>
