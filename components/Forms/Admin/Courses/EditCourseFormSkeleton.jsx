const CourseFormSkeleton = ({ backgroundColor = 'bg-tertiary' }) => (
  <div className="flex flex-col gap-4 pb-10">
    <div className="flex flex-row gap-2">
      ...
      <div className="flex flex-row gap-2 w-full bg-surface border border-border p-6 rounded-lg">
        {/* Course Thumbnail */}
    ...
    <div className="bg-surface border border-border h-100 p-6 rounded-lg">
