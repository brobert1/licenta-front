...
const AddStudyChapterForm = ({ hide, chapter, isJustCreated, refetch }) => {
  ...
  return (
    <HookForm validationSchema={validationSchema} initialValues={values} onSubmit={handleSubmit}>
      <Form className="admin-form chapter-form">
        ...
        <div className="w-full mt-4">
          <Tabs defaultActiveKey="empty" id="study-content-tabs" className="study-layout-tabs mb-3">
        ...
        <div className="col-span-2 flex justify-end">
          <Submit className="button full accent font-semibold text-base">Create Chapter</Submit>
        </div>
      </Form>
    </HookForm>
  );
