  ...
  return (
    <div className="flex flex-col gap-4 justify-center p-4">
      <div className="flex gap-4 items-center">
        ...
        <div
          key={displayMessage}
          className="p-3 rounded-xl bg-tertiary rounded-tl-none shadow-lg w-full max-h-32 overflow-y-auto animate-message-in"
        >
          <p className="text-white text-sm">{displayMessage}</p>
        </div>
      </div>
      {showInfo && (
        <div className="flex gap-2 items-center">
          <p className="text-white font-semibold text-base">{selectedBot.name}</p>
