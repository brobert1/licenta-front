...
const MultiplayerGameDesktop = () => {
  ...
  return (
    <div className="w-full grid grid-cols-5 gap-6">
      ...
      <div
        ref={targetRef}
        className="col-span-2 flex min-h-0 flex-col overflow-hidden rounded-lg border border-border shadow-sm"
      >
...
export default MultiplayerGameDesktop;
