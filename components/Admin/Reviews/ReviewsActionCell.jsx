...
import { ViewReviewDetailsModal } from '@components/Modals';
...
const ReviewsActionCell = ({ refetch, row }) => {
  ...
  return (
    <div className="relative flex gap-2">
      <ActionButton
        icon="fa-regular text-primary fa-eye"
        extraClass="text-interactive hover:text-interactive-hover"
        onClick={handleShow}
        tooltipText="See review"
      />
      {isOpen && (
