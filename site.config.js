...
module.exports = {
  sitename: "Rook'N'Learn | Chess play and study",
  title: "Rook'N'Learn | Chess play and study",
  description: `
  ...
  image: `${process.env.APP_BASE_URL}/images/hess-removebg-preview.png`,
  stylesheets: [
    // Add public or external stylesheets here
    `https://kit.fontawesome.com/${process.env.FONT_AWESOME_KEY}.css`,
    'https://fonts.googleapis.com/css2?family=Noto+Sans:wght@400;500;600;700&family=Poppins:wght@400;500;600;700&display=swap',
