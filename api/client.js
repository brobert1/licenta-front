...
export const joinWaitlist = async (courseId) => {
  return axiosAuth.post(`/client/courses/${courseId}/waitlist`);
};

export const leaveWaitlist = async (courseId) => {
  return axiosAuth.delete(`/client/courses/${courseId}/waitlist`);
};

export const refundOrder = async ({ orderId, reason }) => {
  return axiosAuth.post(`/client/orders/${orderId}/refund`, { reason });
};
